$( document ).ready( function(){
	...
	$('.inicial').delay(1500).fadeIn(500);
		$('.escolha').click(function(){
			...
			$('.escolha').slideUp(1000);
			$('.saudacao').slideUp(1000);
			$('.icones').delay(1200).slideDown(1000);
			$('.'+destino).delay(2300).slideDown(1000);
			$('.voltando').delay(3000).fadeIn(1000);
		});
			$('.voltando').click(function(){
					$('.icones').fadeOut(500);
					$('.telas').fadeOut(500);
				$('.saudacao').delay(1000).fadeIn(500);
				$('.inicial').delay(1500).fadeIn(500);
